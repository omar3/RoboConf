...
public class RoboConfdslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected RoboConfdslSwitch<Adapter> modelSwitch =
    new RoboConfdslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseECARule(ECARule object)
      {
        return createECARuleAdapter();
      }
      @Override
      public Adapter caseECAProperty(ECAProperty object)
      {
        return createECAPropertyAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.roboConf.roboConfdsl.ECARule <em>ECA Rule</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createECARuleAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link com.roboConf.roboConfdsl.ECAProperty <em>ECA Property</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createECAPropertyAdapter()
  {
    return null;
  }
