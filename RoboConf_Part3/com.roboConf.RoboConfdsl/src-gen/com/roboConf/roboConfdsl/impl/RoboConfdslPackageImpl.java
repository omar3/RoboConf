...
public class RoboConfdslPackageImpl extends EPackageImpl implements RoboConfdslPackage
{
   ...
   * @generated
   */
  private EClass ecaRuleEClass = null;
   ...
   * @generated
   */
  private EClass ecaPropertyEClass = null;
   ...
   * @generated
   */
  public EClass getECARule()
  {
    return ecaRuleEClass;
  }
   ...
   * @generated
   */
  public EReference getECARule_Eca_rule_name()
  {
    return (EReference)ecaRuleEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getECARule_Ecaproperties()
  {
    return (EReference)ecaRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getECAProperty()
  {
    return ecaPropertyEClass;
  }
   ...
   * @generated
   */
  public EAttribute getECAProperty_Elastic()
  {
    return (EAttribute)ecaPropertyEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getECAProperty_NumInstances()
  {
    return (EAttribute)ecaPropertyEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getECAProperty_Minallowedinstances()
  {
    return (EAttribute)ecaPropertyEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getECAProperty_Maxallowedinstances()
  {
    return (EAttribute)ecaPropertyEClass.getEStructuralFeatures().get(3);
  }
  ...
  public void createPackageContents()
  {
    ...
    ecaRuleEClass = createEClass(ECA_RULE);
    createEReference(ecaRuleEClass, ECA_RULE__ECA_RULE_NAME);
    createEReference(ecaRuleEClass, ECA_RULE__ECAPROPERTIES);

    ecaPropertyEClass = createEClass(ECA_PROPERTY);
    createEAttribute(ecaPropertyEClass, ECA_PROPERTY__ELASTIC);
    createEAttribute(ecaPropertyEClass, ECA_PROPERTY__NUM_INSTANCES);
    createEAttribute(ecaPropertyEClass, ECA_PROPERTY__MINALLOWEDINSTANCES);
    createEAttribute(ecaPropertyEClass, ECA_PROPERTY__MAXALLOWEDINSTANCES);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(ecaRuleEClass, ECARule.class, "ECARule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getECARule_Eca_rule_name(), this.getComponent(), null, "eca_rule_name", null, 0, 1, ECARule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getECARule_Ecaproperties(), this.getECAProperty(), null, "ecaproperties", null, 0, -1, ECARule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(ecaPropertyEClass, ECAProperty.class, "ECAProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getECAProperty_Elastic(), ecorePackage.getEString(), "elastic", null, 0, 1, ECAProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getECAProperty_NumInstances(), ecorePackage.getEString(), "numInstances", null, 0, 1, ECAProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getECAProperty_Minallowedinstances(), ecorePackage.getEString(), "minallowedinstances", null, 0, 1, ECAProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getECAProperty_Maxallowedinstances(), ecorePackage.getEString(), "maxallowedinstances", null, 0, 1, ECAProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
