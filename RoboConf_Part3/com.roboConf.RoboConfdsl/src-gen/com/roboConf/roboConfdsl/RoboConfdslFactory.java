...
public interface RoboConfdslFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>ECA Rule</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ECA Rule</em>'.
   * @generated
   */
  ECARule createECARule();

  /**
   * Returns a new object of class '<em>ECA Property</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ECA Property</em>'.
   * @generated
   */
  ECAProperty createECAProperty();
