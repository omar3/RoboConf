 ...
 * <ul>
 *   <li>{@link com.roboConf.roboConfdsl.impl.CountImpl#getVal <em>Val</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CountImpl extends MinimalEObjectImpl.Container implements Count
{
  ...
  {
    return RoboConfdslPackage.Literals.COUNT;
  }
  ...
  public void setVal(int newVal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RoboConfdslPackage.COUNT__VAL, oldVal, val));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RoboConfdslPackage.COUNT__VAL:
        return getVal();
    }
